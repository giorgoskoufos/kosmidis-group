...
import com.kosmidis.jarvis.activities.LoginActivity;
import com.kosmidis.jarvis.activities.ProfileCustomisationActivity;
...
public class SettingsMenuDialog extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (userEmail != null && userEmail.toLowerCase().endsWith("@gmail.com")) {
            boolean isGoogleConnected = preferences.getBoolean("isGoogleConnected", false);
            ...
            if (isGoogleConnected) {
                ivMenuItemAppsIcon.setColorFilter(Color.parseColor("#4CAF50")); // Success Green
                tvMenuItemAppsText.setTextColor(Color.parseColor("#4CAF50"));
                tvMenuItemAppsText.setText("Google Integration (Connected)");
            } else {
                ivMenuItemAppsIcon.setColorFilter(Color.parseColor("#D1C4E9")); // Theme Indigo Light
